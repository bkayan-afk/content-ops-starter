...
sections:
  - type: GenericSection
    ...
    actions:
      - label: Our Channel
        altText: ''
        url: 'https://www.youtube.com/@RelaxationAuraStudio'
        showIcon: false
        icon: arrowRight
        iconPosition: right
        style: secondary
    ...
    title:
      ...
      styles:
        self:
          textAlign: center
      type: TitleBlock
    subtitle: Effects of The relaxation aura
    items:
      - type: FeaturedItem
        title: Night Peace
  ...
  - type: GenericSection
    ...
    media:
      ...
      url: 'https://youtu.be/WnJZ_1xXXH8'
      autoplay: true
      loop: true
      muted: true
      controls: false
